...
import { InterviewPlayback } from '@/components/interview/InterviewPlayback';

export const metadata: Metadata = { title: 'Interview playback — ddotsjobs.com' };
export const dynamic = 'force-dynamic';

export default async function InterviewPlaybackPage({ params }: { params: Promise<{ interviewId: string }> }) {
  ...
  return (
    <div style={s.shell}>
      ...
      <main style={s.main}>
        <InterviewPlayback interviewId={interviewId} />
      </main>
    </div>
  );
}
