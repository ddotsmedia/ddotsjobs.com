...
import { ReportsManager } from '@/components/employer/ReportsManager';

export const metadata: Metadata = { title: 'Reports — ddotsjobs.com' };
...
const s: Record<string, React.CSSProperties> = {
  ...
  main: { flex: 1, minWidth: 0, padding: 'var(--space-3) var(--space-2)', display: 'flex', flexDirection: 'column', gap: 'var(--space-2)', maxWidth: 820 },
};
