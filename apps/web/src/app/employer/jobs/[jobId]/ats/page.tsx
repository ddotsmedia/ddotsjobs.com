...
export const metadata: Metadata = { title: 'Pipeline — ddotsjobs.com' };
export const dynamic = 'force-dynamic';

export default async function AtsPage({ params }: { params: Promise<{ jobId: string }> }) {
